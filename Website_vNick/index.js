...
var sportData;
  request('https://geodata.antwerpen.be/arcgissql/rest/services/P_Portal/portal_publiek/MapServer/643/query?where=1%3D1&outFields=*&outSR=4326&f=json',
    function(error, response, body){
      sportData = JSON.parse(body);
    });
