var map, infoWindow;
var fuifruimte = JSON.parse(document.getElementById('snazzy').getAttribute('data-fuifruimte'));
...
function initMap() {
  ...
  for ( var i = 0; i <  fuifruimte.features.length; i++) {
          var marker = new google.maps.Marker({
           position: {lat: fuifruimte.features[i].geometry.y , lng: fuifruimte.features[i].geometry.x },
           map: map });
      };
